          ...
          <div>
            ...
            <div className="mt-3 flex flex-wrap items-center gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center rounded-full border border-amber-500 bg-zinc-950 px-5 py-2.5 text-[11px] font-black uppercase tracking-[0.28em] text-amber-400 shadow-[0_0_14px_rgba(251,146,60,0.22)] transition-all hover:border-amber-400 hover:bg-zinc-900 hover:shadow-[0_0_18px_rgba(251,146,60,0.35)] focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-500/60"
              >
                WhatsApp
              </a>
            </div>
