...
const FloatingQuickActions = () => {
  ...
  return (
    <div className="fixed bottom-6 right-4 z-[60] flex flex-col items-end gap-3 md:bottom-8 md:right-6 pointer-events-none [&>*]:pointer-events-auto">
      <AnimatePresence>
        {visible && (
          <motion.button
            type="button"
      ...
      <a
        ...
        className="flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-black/30 ring-2 ring-white/10 transition-transform hover:scale-105 hover:brightness-105 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary"
      >
