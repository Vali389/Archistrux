      ...
      <Link to={`/services/${service.slug}`} className="group block h-full">
        ...
        >
          ...
          <div className="relative flex flex-col items-center text-center sm:items-start sm:text-left">
            <div className="mb-5 flex h-14 w-14 items-center justify-center rounded-lg bg-primary/15 text-primary ring-1 ring-primary/25 transition-all duration-300 group-hover:scale-105 group-hover:bg-primary/25">
